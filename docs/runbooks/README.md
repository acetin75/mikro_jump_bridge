...
- `muhasebe_buro/settings.py` içinde dönen dosya loglama altyapısı var.
- `muhasebe_buro/permissions.py` rol mantığı için başlangıç seviyesi bir çerçeve sağlıyor.
