...
class FirmaAyarForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "mikro_sunucu": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "192.168.1.10"}
            ),
            "mikro_sunucu_vpn": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "10.8.0.5"}
            ),
            "mikro_sunucu_uzak": forms.TextInput(
